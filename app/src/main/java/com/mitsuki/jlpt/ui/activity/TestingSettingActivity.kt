...
import com.mitsuki.jlpt.ui.adapter.TestingSettingAdapter
...
class TestingSettingActivity : BaseActivity<TestingSettingViewModel>() {
    ...
    private val mAdapter = TestingSettingAdapter()
    ...
    private fun onSettingEvent(setting: Setting) {
        when (setting.type) {
            ...
            Setting.SETTING_TESTING_JUDGE -> viewModel.onJudgeChange(setting.ext as Boolean)
        }
    }
